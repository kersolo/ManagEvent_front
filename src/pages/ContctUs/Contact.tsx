                ...
                <form className="p-5" onSubmit={handleSubmit(onSubmit)} >
                    <div className="sm:w-7/12 sm:mx-auto md:w-5/12 md:mx-auto lg:w-4/12 lg:mx-auto border-2 xl:w-3/12 xl:mx-auto border-orange-300 rounded p-5 mt-10">
                        ...
                        <div className="mb-1 flex flex-col gap-3">
                            <Input  onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} crossOrigin={undefined} {...register("nom")} type="text" label="nom" name="nom" />
                            <small className="text-sm text-red-500">{errors.nom?.message}</small>
                            <Input  onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} crossOrigin={undefined} {...register("prenom")} type="text" label="prenom" name="prenom" />
